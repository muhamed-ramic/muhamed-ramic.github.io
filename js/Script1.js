...
var tipTwoOfKind = false,
    tipThreeOfKind = false;
var Interval;
...
var slika, slikaZaPromjenit, divZaPromjenit, nizProslihSource, z, y, idiDalje2 = false,
    dalje = false;
...
var vecOtkrivenaKarta = false,
    nizRezultatA, uradiJenom = false;
    ...
    if (tipTwoOfKind) {
        ...
        if (nizSlikaZaUporedit.length % 2 == 0 && nizSlikaZaUporedit.length > 0) {
            ...
            if (nizSlikaZaUporedit[velicinaN - 1].src != nizSlikaZaUporedit[velicinaN - 2].src) {
                ...
                setTimeout(function () {
                    nizSlikaZaUporedit[velicinaN - 1].src = sourcePravi;
                }, 1500);
                nizSlikaZaUporedit[velicinaN - 2].classList.add("transformationN");
                setTimeout(function () {
                    nizSlikaZaUporedit[velicinaN - 2].src = sourcePravi;
                }, 1500);
        ...
        if (nizSlikaZaUporedit.length % 3 == 0 && nizSlikaZaUporedit.length > 0) {
            ...
            if (nizSlikaZaUporedit[velicinaN - 1].src != nizSlikaZaUporedit[velicinaN - 2].src && nizSlikaZaUporedit[velicinaN - 1].src != nizSlikaZaUporedit[velicinaN - 3].src &&
                ...
                setTimeout(function () {
                    nizSlikaZaUporedit[velicinaN - 3].src = sourcePravi;
                }, 1500);
